! function(e, t) {
    ...
    var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        He = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Setiembre_Octubre_Noviembre_Diciembre".split("_");
    var Re = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Setiembre_Octubre_Noviembre_Diciembre".split("_");
    ...
    var wt = /^(?:(Lun|Mar|Mie|Jue|Vie|Sab|Dom),?\s)?(\d{1,2})\s(Ene|Feb|Mar|Abr|May|Jun|Jul|Ago|Set|Oct|Nov|Dic)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
